...
import { ThetanArenaWebService } from '../webServices/ThetanArenaWebService';
import { Command } from './command';

export class ThetanArenaCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.thetanarena'),
        description: Lang.getCom('commandDescs.thetanarena'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await ThetanArenaWebService();
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.thetanarena', data.lang(), {
