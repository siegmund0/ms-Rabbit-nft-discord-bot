...
import { WanakaFarmWebService } from '../webServices/WanakaFarmWebService';
import { Command } from './command';

export class WanakaFarmCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.wanakafarm'),
        description: Lang.getCom('commandDescs.wanakafarm'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await WanakaFarmWebService();
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.wanakafarm', data.lang(), {
