...
import { CryptoCarsWorldWebService } from '../webServices/CryptoCarsWorldWebService';
import { Command } from './command';

export class CryptoCarsWorldCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.cryptocarsworld'),
        description: Lang.getCom('commandDescs.cryptocarsworld'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await CryptoCarsWorldWebService();
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.cryptocarsworld', data.lang(), {
