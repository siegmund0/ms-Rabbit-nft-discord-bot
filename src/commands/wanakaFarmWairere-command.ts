...
import { WanakaFarmWairereWebService } from '../webServices/WanakaFarmWairereWebService';
import { Command } from './command';

export class WanakaFarmWairereCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.wanakafarmwairere'),
        description: Lang.getCom('commandDescs.wanakafarmwairere'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await WanakaFarmWairereWebService();
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.wanakafarmwairere', data.lang(), {
