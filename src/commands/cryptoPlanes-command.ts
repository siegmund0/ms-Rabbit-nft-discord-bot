...
import { CryptoPlanesWebService } from '../webServices/CryptoPlanesWebService';
import { Command } from './command';

export class CryptoPlanesCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.cryptoplanes'),
        description: Lang.getCom('commandDescs.cryptoplanes'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await CryptoPlanesWebService();
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.cryptoplanes', data.lang(), {
