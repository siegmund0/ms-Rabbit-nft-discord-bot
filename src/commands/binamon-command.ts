...
export class BinamonCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.binamon'),
        description: Lang.getCom('commandDescs.binamon'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await GenericWebService.getData(GamesConstantsEnum.Binamon);
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.binamon', data.lang(), {
