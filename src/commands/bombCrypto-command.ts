...
import { BombCryptoWebService } from '../webServices/BombCryptoWebService';
import { Command } from './command';

export class BombCryptoCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.bombcrypto'),
        description: Lang.getCom('commandDescs.bombcrypto'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await BombCryptoWebService();
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.bombcrypto', data.lang(), {
