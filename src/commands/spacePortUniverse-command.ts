...
import { SpacePortUniverseWebService } from '../webServices/SpacePortUniverseWebService';
import { Command } from './command';

export class SpacePortUniverseCommand implements Command {
    public data: ApplicationCommandData = {
        name: Lang.getCom('commands.spaceportuniverse'),
        description: Lang.getCom('commandDescs.spaceportuniverse'),
    };
    ...
    public async execute(intr: CommandInteraction, data: EventData): Promise<void> {
        let response = await SpacePortUniverseWebService();
        ...
        await MessageUtils.sendIntr(
            intr,
            Lang.getEmbed('displayEmbeds.spaceportuniverse', data.lang(), {
